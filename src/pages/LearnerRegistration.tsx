...
import { Loader2, GraduationCap, Sparkles, Eye, EyeOff } from "lucide-react";
import { z } from "zod";
      ...
      const { data: signUpData, error: authError } = await supabase.auth.signUp({
        ...
        options: {
          ...
          data: {
            ...
            subjects_of_interest: finalSubjects,
          },
        },
      });
      ...
      <Card className="w-full max-w-2xl shadow-2xl border-2 relative z-10">
        <CardHeader className="space-y-4">
          ...
          <CardDescription className="text-center text-base">
            Complete your profile to get started as a learner
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-6 pt-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="yearLevel" className="text-sm font-semibold">Registered Year/Level</Label>
